...
/* complesso::complesso(double r, double i){  //costruttore alternativo
	m_real=r;
	m_imag=i;
} */
...
/*
complesso complesso::operator+= (const complesso & addendo){		//non funziona
	complesso (m_real, m_imag) ;					//deve fare c1 = c1+c2 restituendo c1 aggiornato
	complesso.m_real = complesso.m_real + addendo.m_real ;
 complesso.m_imag = complesso.m_imag + addendo.m_imag ;
 return complesso ; 
} */
